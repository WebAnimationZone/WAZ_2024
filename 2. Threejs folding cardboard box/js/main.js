...
function createCopyright() {
    ...
    ctx.textAlign = 'end';
    ctx.fillText('github.com', canvas.width - 30, 30);
    ctx.fillText('Web Animation Zone', canvas.width - 30, 70);
...
function trackLinks() {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (linkCode === 1) {
            window.open('https://github.com/WebAnimationZone', '_blank').focus();
        } else if (linkCode === 2) {
            window.open('https://www.youtube.com/channel/UCFotI98pUbvod-OCe6r1xxA/videos', '_blank').focus();
        }
    });
